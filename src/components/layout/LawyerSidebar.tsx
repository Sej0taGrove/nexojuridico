...
const NAV_ITEMS: readonly NavItem[] = [
  { href: "/feed", label: "Feed de casos", icon: Inbox },
  { href: "/mis-casos-abogado", label: "Mis casos", icon: Briefcase },
  { href: "/dashboard-abogado", label: "Dashboard", icon: BarChart3 },
  { href: "/configuracion", label: "Configuración", icon: Settings },
  { href: "/perfil-abogado", label: "Mi perfil", icon: User },
] as const;
        ...
        <div className="flex items-center justify-between px-6 pb-2">
          <Link href="/feed" className="flex items-center gap-3">
            ...
            <span className="flex flex-col leading-tight">
              ...
              <span className="text-xs text-navy-200">Abogado</span>
            </span>
          </Link>
          <button
            type="button"
